# Generated by Django 4.2.4 on 2023-11-09 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=250, verbose_name='Nombre')),
                ('producto', models.ManyToManyField(to='ecommerce.producto')),
            ],
        ),
        migrations.CreateModel(
            name='Carrito',
            fields=[
                ...
                ('items_carrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce.itemcarrito')),
            ],
        ),
    ]
